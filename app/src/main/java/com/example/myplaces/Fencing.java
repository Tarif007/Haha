...
public class Fencing implements ResultCallback {

    // Constants
    public static final String TAG = Fencing.class.getSimpleName();
    ...
    public Fencing(Context context, GoogleApiClient client) {
        mContext = context;
